...
Public Class Serialization_Utilities
    ...
    Public Shared Sub Load_Object_FileSystem_And_Deserialize(Of T)(ByVal fileName As String,
                                                                                                                         ByRef item As T,
    ...
    Public Class ThreadSafe
        ...
        Public Sub Load_Object_FileSystem_And_Deserialize(Of T)(ByVal fileName As String,
                                                                                                                             ByRef item As T,
                                                                                                                             Optional ByRef success As Boolean = False)
        ...
        Public Sub Serialize_Object(Of T)(ByRef bytes As Byte(),
                                                                    ByRef item As T,
